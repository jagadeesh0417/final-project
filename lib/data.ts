...
/** 24 curated image sets — one per property, 4 photos each */
const IMAGES: Record<string, string[]> = {
  "MP-1001": [
    IMG("1600596542815-ffad4c1539a9"),
    IMG("1600585154340-4a2b5b7b0e8a"),
    IMG("1600573472550-3f2a5a1bb8a5"),
    IMG("1600607687939-4e6f6e3b87c7"),
  ],
  "MP-1002": [
    IMG("1560448204473-3e1f05e5a5b0"),
    IMG("1512917771580-5a1e3617b1f8"),
    IMG("1600607687644-aac4c3eac7f4"),
    IMG("1600210492486-724fe3c67fb0"),
  ],
  "MP-1003": [
    IMG("1500382016768-2b7b2c2e4d3a"),
    IMG("1470070322-4a5b5c6d7e8f"),
    IMG("1564013799919-ab600027f2f9"),
    IMG("1500382016768-2b7b2c2e4d3a"),
  ],
  "MP-1004": [
    IMG("1497366817658-2a8c6d2f6a8e"),
    IMG("1497366216548-3c5c1e8b9c5a"),
    IMG("1504384308090-8943ec3c8e5b"),
    IMG("1517506577888-73f7f8c7e8a9"),
  ],
  "MP-1005": [
    IMG("1545322770-1d50f2c2c1b3"),
    IMG("1512917771580-5a1e3617b1f8"),
    IMG("1560448204473-3e1f05e5a5b0"),
    IMG("1600210492486-724fe3c67fb0"),
  ],
...
].map((p) => ({ ...p, images: IMAGES[p.id] })) as Property[];
