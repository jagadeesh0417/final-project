    ...
    <section className="section bg-[#f5f3ef]">
      <div className="container-lux">
        ...
        >
          ...
          <h2 className="display d-xl mt-3">Interiors &amp; Architecture</h2>
        </motion.div>
        ...
        <div className="columns-2 gap-4 md:columns-3 lg:columns-4">
          {IMAGES.map((src, i) => (
            <motion.button
              ...
              className="group relative mb-4 w-full overflow-hidden rounded-[var(--radius)]"
            >
              <img
                src={src}
                alt=""
        ...
        <AnimatePresence>
          {lightbox !== null && (
            ...
            >
              <button onClick={() => setLightbox(null)} className="absolute right-6 top-6 text-3xl text-white/50 transition-colors hover:text-white">&times;</button>
              <motion.img
                key={lightbox}
