  ...
  return (
    <section className="relative overflow-hidden" style={{ paddingBlock: "140px" }}>
      <div className="absolute inset-0">
        <img src="https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?w=1920&q=85" alt="" className="h-full w-full object-cover" style={{ filter: "brightness(0.45)" }} />
      ...
      >
        ...
        <div className="mt-10 flex flex-wrap gap-4">
          <Link href="/contact" className="btn-lux btn-white">
            Book Viewing
